 ...
 *
 * $URL: https://scummvm.svn.sourceforge.net/svnroot/scummvm/scummvm/tags/release-1-0-0/engines/agos/charset-fontdata.cpp $
 * $Id: charset-fontdata.cpp 42163 2009-07-06 06:21:59Z Kirben $
 *
 */
...
static const byte polish_feebleFontSize[208] = {
...
uint AGOSEngine::getFeebleFontSize(byte chr) {
	if (getGameType() == GType_FF && (getFeatures() & GF_DEMO) && chr == 32)
		...
		return polish_feebleFontSize[chr - 32];
	else
		return feebleFontSize[chr - 32];
}

static const byte polish_feeble_windowFont[] = {
