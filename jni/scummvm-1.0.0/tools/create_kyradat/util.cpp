 ...
 *
 * $URL: https://scummvm.svn.sourceforge.net/svnroot/scummvm/scummvm/tags/release-1-0-0/tools/create_kyradat/util.cpp $
 * $Id: util.cpp 30963 2008-02-25 14:13:12Z fingolfin $
 *
 */
...
#if defined(ANDROID)
	__android_log_print(ANDROID_LOG_ERROR, "ScummVM, DEBUG: %s!\n", buf);
#else
