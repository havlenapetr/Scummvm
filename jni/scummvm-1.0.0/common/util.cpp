 ...
 *
 * $URL: https://scummvm.svn.sourceforge.net/svnroot/scummvm/scummvm/tags/release-1-0-0/common/util.cpp $
 * $Id: util.cpp 42446 2009-07-13 18:47:32Z lordhoto $
 */
...
#if defined(ANDROID)
	__android_log_print(ANDROID_LOG_ERROR, "ScummVM", "WARNING: %s!", buf);
#endif
...
#if defined(ANDROID)
	__android_log_print(ANDROID_LOG_ERROR, "ScummVM", "ERROR: %s!", buf_output);
#endif
