 ...
 *
 * $URL: https://scummvm.svn.sourceforge.net/svnroot/scummvm/scummvm/tags/release-1-0-0/common/config-file.cpp $
 * $Id: config-file.cpp 40725 2009-05-19 11:42:14Z fingolfin $
 *
 */
